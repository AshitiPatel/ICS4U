...
public class TextPicture extends Picture{
	...
	public static void main(String[] args) {
		...
		textPic.setColor(Color.blue);
		display.setVisible(true);
		
		//pause before the next trial
		JOptionPane.showMessageDialog(null, "Wait");	
		
		//trial for changing title (with some additional changes to make it look different)
		textPic.setColor(Color.darkGray);
		textPic.setxPos(75);
		textPic.setyPos(75);
		...
		//trial for changing font (with some additional changes to make it look different)
		textPic.setColor(Color.green);
		textPic.setxPos(50);
		textPic.setyPos(50);
